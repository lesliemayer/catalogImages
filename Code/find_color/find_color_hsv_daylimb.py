...
# python find_color_hsv_daylimb.py I:\ISS051\ --log=debug --list="E:\ISS051\day_earthlimb.txt" --out="E:\ISS051\DayLimb"
...
if findAurora :
    ...
    colorUpper = np.array([179, 255, 25], dtype = "uint8")

else :
    # throw an exception
    sys.exit("findAurora or findLightning or findDayLimb has to be true")
